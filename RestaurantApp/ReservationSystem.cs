...
class ReservationSystem
{
    ...
    public void SystemRun()
    {
        ...
        else
        {
            ...
            Console.WriteLine($"Selected Table: Table {selectedTable.TableNumber} (Capacity: {selectedTable.Capacity})");
            ...
            Console.WriteLine($"\nYou reserved Table {selectedTable.TableNumber} with a capacity of {selectedTable.Capacity} seats for your group of {numberOfPeople} people on {selectedDate:dd-MM-yyyy} for the timeslot: {selectedTimeSlot}.");
    ...
    // Constructors toevoegen aan classes.
